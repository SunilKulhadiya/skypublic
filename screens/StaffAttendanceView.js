                                ...
                                fontSize: 17 }}>:</Text>
                        {
                            ...
                            Itms.staff_attendance_type_id == 1 ? (
                                ...
                                Itms.staff_attendance_type_id == 2 ? (
                                    ...
                                    Itms.staff_attendance_type_id == 3 ? (
                                        <MaterialCommunityIcons name="alpha-a-box-outline"
                                        size={30} color="red" />
                                    ):(
                                        Itms.staff_attendance_type_id == 4 ? (
                                            <MaterialCommunityIcons name="alpha-h-circle-outline"
                                            size={30} color = "#3003F7"
                                            key={Itms.id}/>
                                    ):(
                                        Itms.staff_attendance_type_id == 5 ? (
    ...
    return (
        <SafeAreaView>
            <View style={styles.Mcontainer}>
                ...
                <View style={{flexDirection: "column", marginLeft: 10, marginTop: 50}}>
                    <View style={{flexDirection: "row"}}>
                        <MaterialCommunityIcons name="alpha-h-circle-outline"
                            size={30} color = "#3003F7"/>
                        <Text style={{fontSize: 17, marginTop: 1}}>Half Day</Text>
                        <MaterialCommunityIcons name="alpha-h-box-outline"
                            size={30} color = "#0D885C" style={{marginLeft: 135}}/>
                        <Text style={{fontSize: 17, marginTop: 1}}>Holiday</Text>
                    </View>
                    <View style={{flexDirection: "row"}}>
                        <MaterialCommunityIcons name="alpha-l-circle-outline"
                            size={30} color = "#FBC612"/>
                        <Text style={{fontSize: 17, marginTop: 1}}>Late</Text>
                        <MaterialCommunityIcons name="alpha-l-box-outline"
                            size={30} color = "#FB12F1" style={{marginLeft: 170}}/>
                        <Text style={{fontSize: 17, marginTop: 1}}>Leave</Text>
                    </View>
                    <View style={{flexDirection: "row"}}>
                        <MaterialCommunityIcons name="alpha-p-box-outline"
                            size={30} color = "#08F543"/>
                        <Text style={{fontSize: 17, marginTop: 1}}>Full Day/Present</Text>
                        <MaterialCommunityIcons name="alpha-a-box-outline"
                            size={30} color = "red" style={{marginLeft: 65}}/>
                        <Text style={{fontSize: 17, marginTop: 1}}>Absent</Text>
                    </View>
                </View>
