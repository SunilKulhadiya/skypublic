...
const AboutUs = ({navigation}) => {
  return (
    <View style={{alignItems: "center"}}>
      <View style={{width: DEVICEWIDTH, height: DEVICEHEIGHT * 0.063, backgroundColor: "#FFFFFF", justifyContent: "center"}}>
        <AntDesign name="arrowleft" size={35} color="#000000" onPress={() => navigation.goBack()}/>
      </View>
    <View style={styles.center}>
        <Image style={styles.LogoSize} source={require('../assets/Backup_of_SDLogo1.png')}/>
